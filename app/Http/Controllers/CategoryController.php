...
class CategoryController extends Controller
{
    ...
    public function update(Category $category, UpdateCategoryRequest $request)
    {
        ...
        if ($this->modelExists($this->category, 'name', $request->name)) {
            return redirect()->back()
                ->with('message', 'Cannot update category name to this name as it already exists or was only temporarily deleted.')
