    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-white-50 bg-white">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                ...
                class="flex border-solid shadow-md items-center p-3 text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600 active:bg-gray-600 rounded-2 mt-10 group">
            ...
            <li class="">
                ...
                class="flex border-solid shadow-md rounded-2 items-center p-3 text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600 active:bg-gray-600 mt-5 group">
            ...
            <li>
                <a href="{{ route('dashboard') }}"
                class="flex border-solid shadow-md items-center p-3 mt-5 text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600 active:bg-gray-600 rounded-2 group">
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
