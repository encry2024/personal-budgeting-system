            ...
            <div class="m-3">
                <form method="POST" action="{{ route('expense.update', $expense->id) }}">
                    ...
                    <label class="inline-block mb-5">
                        ...
                        <input type="string" id="expense-name" name="name" class="inline-block w-100 rounded-md border
                    ...
                    <div class="block mt-4">
                        <button id="expense-update-btn" type="submit" class="text-[14px] rounded-md bg-green-700 py-2 px-2 text-white w-30 shadow-xl
...
<script type="module">
    $(document).ready(function () {
        ...
        $("#expense-update-btn").click(function (e) {
            if (expenseName === $("#expense-name").val()) {
                e.preventDefault();

                Swal.fire({
                    title: 'No Changes',
                    icon: 'info',
                    html: 'No changes were made since there were no update on the expense name.',
